...
const upbx = [
  {
    head: "BITRIX",
    subtl: ["Bitrix24", "Pricing", "Media kit", "Contact us", "In the press"],
  },
  {
    head: "SUPPORT",
    subtl: [
  ...
  {
    head: "ON-PREMISE",
    subtl: ["On-premise edition", "Download", "Documentation"],
  },
  {
    head: "APPS",
    subtl: ["Market", "Mobile app", "Desktop app", "API/developers"],
  },
  {
    head: "PARTNERS",
    subtl: ["Find a partner", "Become a partner", "Partner login"],
  },
];
        ...
        <Flex justify="space-around">
          {upbx.map((bx) => (
            <Stack key={bx.head}>
              ...
              {bx.subtl.map((stl) => (
                <Text className={styles.txsbtl}>{stl}</Text>
              ))}
            </Stack>
          ))}
        </Flex>
      ...
      <Box mt="40px">
        <Flex justify="space-between">
          <Box>
            <Flex mb="20px" gap={5}>
              {downflx.map((t) => (
                <Text className={styles.txtrm}>{t}</Text>
              ))}
            </Flex>
            ...
            <Flex justify="right" gap={5} mb="20px">
              ...
              <Box>
                <svg height="40" width="135" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M130 40H5c-2.8 0-5-2.3-5-5V5c0-2.7 2.3-5 5-5h125c2.8 0 5 2.3 5 5v30c0 2.8-2.2 5-5 5z"></path>
                  <path
                    d="M130 .8c2.3 0 4.2 1.9 4.2 4.2v30c0 2.3-1.9 4.2-4.2 4.2H5C2.7 39.2.8 37.3.8 35V5C.8 2.7 2.7.8 5 .8zm0-.8H5C2.3 0 0 2.3 0 5v30c0 2.8 2.3 5 5 5h125c2.8 0 5-2.3 5-5V5c0-2.7-2.2-5-5-5z"
                    fill="#a6a6a6"
                  ></path>
                  <g fill="#fff">
                    <path
                  ...
                  ></path>
                  <path
                    d="M10.4 32.3c-.3-.3-.4-.8-.4-1.4v.1c0 .6.2 1.1.5 1.4v-.1zM32 21.3l-5 2.8.1.1 4.9-2.8c.7-.4 1-.9 1-1.4 0 .5-.3.9-1 1.3z"
                    opacity=".12"
                  ></path>
                  <path
