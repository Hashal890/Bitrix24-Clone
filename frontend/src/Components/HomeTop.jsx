...
const HomeTop = () => {
    ...
    return (
        <Box mt="100px">
            <Text mb="20px" className={styles.txhd}>Bitrix24. Your ultimate workspace.</Text>
            <Flex mb="20px" justify="space-around">
                {cntnt.map((t) => <Text key={t.id} id={t.id} onClick={()=>setIndex(t.id)} className={styles.txhd1}>
                    {t.heading}
                </Text>)}
            </Flex>
            ...
            <Flex mb="20px" justify="space-around">
                <Stack textAlign="left">
                    {
                        cntnt[index].points.map((p) => <Flex align='center'>
            ...
            <Flex gap={5} p="40px" align="center" bg="#3cc8f4">
                ...
                <Text className={styles.skycloud2}>organizations have chosen Bitrix24</Text>
                <Flex align='center'>
                    <GiGlobe size="40px" color="#ffffff" />
                    <Text className={styles.skycloud2}>available in</Text>
                    <Box borderRadius="50px" backgroundColor="ffffff" p={3} className={styles.skycloud2}> 18 </Box>
